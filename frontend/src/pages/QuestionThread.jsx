    ...
    <div className="min-h-screen bg-background-light py-8 font-sans text-brand-deep">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-xl2 bg-white shadow-soft">
          {/* Status Bar */}
          <div
            className={`h-1.5 w-full ${question.status === "open" ? "bg-accent-orange" : "bg-emerald-500"}`}
          ></div>
          ...
          <div className="p-6 md:p-8">
            <div className="flex items-start justify-between gap-4">
              ...
              {/* Status Badge */}
              <div
                className={`flex shrink-0 items-center gap-1.5 rounded-full px-3 py-1 text-xs font-bold uppercase tracking-wide border ${
        ...
        <div className="mt-10">
          <div className="mb-6 flex items-center gap-3">
            <h2 className="text-xl font-bold text-brand-deep">
              Answers{" "}
              <span className="ml-2 rounded-lg bg-brand-deep/5 px-2 py-0.5 text-base text-brand-mid">
                {answers.length}
              </span>
            </h2>
          </div>
