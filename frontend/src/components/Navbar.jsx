        ...
        <div className="hidden items-center gap-4 md:flex">
          {!user ? (
            <>
              <NavLink
                to="/login"
                className="text-sm font-bold text-gray-500 hover:text-brand-deep"
              >
                Log in
              </NavLink>
              <NavLink
          ...
          <div className="flex flex-col space-y-4">
            ...
            {!user ? (
              <div className="flex flex-col gap-3">
                <NavLink
                  to="/login"
                  className="w-full rounded-xl border border-gray-200 py-3 text-center text-sm font-bold text-gray-700"
                >
                  Log in
                </NavLink>
                <NavLink
                  to="/signup"
                  className="w-full rounded-xl bg-brand-deep py-3 text-center text-sm font-bold text-white"
                >
                  Get Started
                </NavLink>
              </div>
